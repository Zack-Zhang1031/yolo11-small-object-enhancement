...
The test suite covers module gradients, invalid configurations, model construction, training-mode forward passes, rectangular inputs, automatic padding, bundled YAML resources, Ultralytics registration, and runtime P2/P3/P4/P5 feature scales.
